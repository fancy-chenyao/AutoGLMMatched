...
AUTOGLM_PHONE = AgentPersona(
    ...
    allowed_tools=[
        ...
        Tools.home.__name__,
        Tools.wait.__name__,
        Tools.take_over.__name__,
        Tools.note.__name__,
        Tools.call_api.__name__,
        Tools.interact.__name__,
    ],
    required_context=[
        "ui_state",
        "screenshot",
    ...
    **当前任务目标:**
    ...
    请根据当前屏幕状态和 UI 树，给出你的思考和下一步动作。
    """,

    system_prompt="""今天的日期是: """ + formatted_date + """
你是一个智能体分析专家，可以根据操作历史和当前状态图执行一系列操作来完成任务。
你必须严格按照要求输出以下格式：
<[PLHD20_never_used_51bce0c785ca2f68081bfa7d91973934]>{think}<[PLHD21_never_used_51bce0c785ca2f68081bfa7d91973934]>
<[PLHD41_never_used_51bce0c785ca2f68081bfa7d91973934]>{action}<[PLHD21_never_used_51bce0c785ca2f68081bfa7d91973934]>
